...
#ifndef STORAGE_LLDB_INCLUDE_ENV_H_
#define STORAGE_LLDB_INCLUDE_ENV_H_
...
class Env {
 public:
  ...
  //
  // The result of Default() belongs to lldb and must never be deleted.
  static Env* Default();
  ...
  // the lldb implementation) must be prepared to deal with
...
#endif  // STORAGE_LLDB_INCLUDE_ENV_H_
